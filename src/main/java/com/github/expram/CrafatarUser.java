...
import com.github.expram.exceptions.InvalidScaleException;
import com.github.expram.exceptions.InvalidSizeException;
...
public class CrafatarUser extends Utils {
    ...
    public CrafatarFile getCape(String defaultskin) throws InvalidUUIDException, ServerIssuesException {
